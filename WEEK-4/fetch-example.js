...
const chairPluralRegex = /chair(s)?/;
const joan = chairPluralRegex.exec("chair");
const joan2 = chairPluralRegex.test("");
console.log(joan); // ["chair", undefined]
console.log(joan2); // false
...
const regx = /(\w+)\s(\w+)/;
const result = regx.exec("Chair Wooden");
